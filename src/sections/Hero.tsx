...
export const Hero = () => {
  return (
    ...
    >
      ...
      {/* End Ring-1 */}
      {/* Start Ring-2 */}
      <div className="absolute h-[444px] w-[444px] md:h-[780px] md:w-[780px] rounded-full border border-white/20 border-dashed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"></div>
      {/* End Ring-2 */}
      {/* Start Ring-3 */}
